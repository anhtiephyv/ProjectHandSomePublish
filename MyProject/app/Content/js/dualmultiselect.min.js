var a; (a = angular.module("dualmultiselect", [])).directive("dualmultiselect", [function ()
{
    return {
        restrict: "E",
        scope: { options: "=" },
        controller: ["$scope", function (e) { e.transfer = function (e, t, l) { if (l >= 0) t.push(e[l]), e.splice(l, 1); else { for (var s = 0; s < e.length; s++) t.push(e[s]); e.length = 0 } } }],
